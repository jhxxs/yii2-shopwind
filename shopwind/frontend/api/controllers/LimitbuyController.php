...
class LimitbuyController extends \common\base\BaseApiController
{
    ...
    public function actionList()
    {
		...
		{
			$promotion = $promotool->getItemProInfo($value['goods_id'], $value['spec_id']);
    ...
    public function actionRead()
    {
		...
		if(!$post->queryrules) {
			$promotool = Promotool::getInstance()->build();
			$record['promotion'] = array_merge($promotool->getItemProInfo($record['goods_id'], $post->spec_id), LimitBuyModel::getSpeedOfProgress($record['id'], $record['goods_id'], false));
		} else {
