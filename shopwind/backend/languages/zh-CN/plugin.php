...
return array(
	...
	'wxpay'  			=> '微信支付',
    'wxpay_desc'   		=> '微信支付是集成在微信客户端内的支付功能，用户可以通过手机唤起微信客户端快速完成支付。支持公众号JSAPI支付、H5支付（非微信浏览器）。<a href="https://mp.weixin.qq.com" target="_blank">接口申请</a>',
    ...
    'wxapppay'  		=> '微信APP支付',
    'wxapppay_desc'     => '微信APP支付是客户端（iOS、Android）唤起的支付功能，拥有更好的体验，支持电脑端的微信二维码支付。<a href="https://open.weixin.qq.com" target="_blank">接口申请</a>',
