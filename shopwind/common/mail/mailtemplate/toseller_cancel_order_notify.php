...
<p style="padding-left: 30px;"><a href="{$base_url}/seller/order/detail/{$order.order_id}" target="_blank">{$base_url}/seller/order/detail/{$order.order_id}</a></p>
<p style="padding-left: 30px;">查看您的订单列表管理页请点击以下链接</p>
<p style="padding-left: 30px;"><a href="{$base_url}/seller/order/list" target="_blank">{$base_url}/seller/order/list</a></p>
