...
class DbSessionStorage implements StorageInterface
{
    ...
    {
		$items = [];
		$carts = CartModel::find()->select('rec_id,userid,gtype,store_id,goods_id,goods_name,spec_id,specification,price,quantity,goods_image,product_id,selected')->where(['userid' => $this->userId])->all();
