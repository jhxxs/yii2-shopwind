...
class User extends Component
{
    ...
    {  
		...
		if($request->getIsAjax()) {
			...
			Yii::$app->getResponse()->data = ['done' => false, 'icon' => 'warning', 'msg' => Yii::t('yii', 'Login Required'), 'loginUrl' => \yii\helpers\Url::toRoute($this->loginUrl, true), 'returnUrl' => $request->getUrl()];
			return false;
		}
