...
namespace common\plugins\payment\wxapppay;
...
use common\plugins\payment\wxapppay\lib\App_pub;
use common\plugins\payment\wxapppay\lib\UnifiedOrder_pub;
use common\plugins\payment\wxapppay\lib\Notify_pub;
...
class SDK
{
	...
	public function getPayform($orderInfo = array(), $post = null)
	{
		...
		// 返回给APP客户端参数
		$client = new App_pub($this->config);
