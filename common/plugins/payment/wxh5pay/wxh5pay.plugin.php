...
namespace common\plugins\payment\wxh5pay;
...
use common\plugins\payment\wxh5pay\SDK;

/**
 * @Id wxh5pay.plugin.php 2018.6.3 $
 * @author mosir
 */

class Wxh5pay extends BasePayment
{
	/**
	 * 网关地址
	 * @var string $gateway
